  ...
  ({
    ...
    palette: {
      ...
      warning: {
        ...
        100: '#FFF3C1',
        200: '#FFECA1',
        300: '#ffbc6d', // vs blueDark900: WCAG 10.4 AAA, APCA 72 Ok for text
        400: '#ffa943', // vs blueDark900: WCAG 6.4 AA normal, APCA 48 Only large text
        500: '#ff9f2e', // vs blueDark900: WCAG 8 AAA normal, APCA 58 Only large text
        main: '#ff9f2e',
        600: '#e68f29', // vs blueDark900: WCAG 6.4 AA normal, APCA 48 Only large text
        700: '#cc7f25', // vs white bg: WCAG 4.4 AA large, APCA 71 Ok for text
        800: '#995f1c', // vs white bg: WCAG 5.9 AAA large, APCA 80 Best for text
